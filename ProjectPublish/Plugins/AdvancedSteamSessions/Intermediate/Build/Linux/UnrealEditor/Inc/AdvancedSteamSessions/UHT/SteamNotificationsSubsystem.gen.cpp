...
// ********** Begin Delegate FOnSteamOverlayActivated constinit property declarations **************
...
// ********** End Delegate FOnSteamOverlayActivated constinit property declarations ****************
	static const UECodeGen_Private::FDelegateFunctionParams FuncParams;
};

// ********** Begin Delegate FOnSteamOverlayActivated Property Definitions *************************
...
// ********** End Delegate FOnSteamOverlayActivated Property Definitions ***************************
const UECodeGen_Private::FDelegateFunctionParams Z_Construct_UDelegateFunction_AdvancedSteamSessions_OnSteamOverlayActivated__DelegateSignature_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UPackage__Script_AdvancedSteamSessions, nullptr, "OnSteamOverlayActivated__DelegateSignature", 	Z_Construct_UDelegateFunction_AdvancedSteamSessions_OnSteamOverlayActivated__DelegateSignature_Statics::PropPointers, 
	UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_AdvancedSteamSessions_OnSteamOverlayActivated__DelegateSignature_Statics::PropPointers), 
sizeof(Z_Construct_UDelegateFunction_AdvancedSteamSessions_OnSteamOverlayActivated__DelegateSignature_Statics::_Script_AdvancedSteamSessions_eventOnSteamOverlayActivated_Parms),
...
// ********** Begin Class USteamNotificationsSubsystem constinit property declarations *************
	static const UECodeGen_Private::FMulticastDelegatePropertyParams NewProp_OnSteamOverlayActivated_Bind;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End Class USteamNotificationsSubsystem constinit property declarations ***************
...
// ********** Begin Class USteamNotificationsSubsystem Property Definitions ************************
...
// ********** End Class USteamNotificationsSubsystem Property Definitions **************************
...
DEFINE_VTABLE_PTR_HELPER_CTOR_NS(, USteamNotificationsSubsystem);
USteamNotificationsSubsystem::~USteamNotificationsSubsystem() {}
// ********** End Class USteamNotificationsSubsystem ***********************************************

// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_home_daantje_Documents_SchoolProjecten_Project_publish_ProjectPublish_Plugins_AdvancedSteamSessions_Source_AdvancedSteamSessions_Classes_SteamNotificationsSubsystem_h__Script_AdvancedSteamSessions_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_USteamNotificationsSubsystem, USteamNotificationsSubsystem::StaticClass, TEXT("USteamNotificationsSubsystem"), &Z_Registration_Info_UClass_USteamNotificationsSubsystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USteamNotificationsSubsystem), 3983132293U) },
	};
}; // Z_CompiledInDeferFile_FID_home_daantje_Documents_SchoolProjecten_Project_publish_ProjectPublish_Plugins_AdvancedSteamSessions_Source_AdvancedSteamSessions_Classes_SteamNotificationsSubsystem_h__Script_AdvancedSteamSessions_Statics 
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_home_daantje_Documents_SchoolProjecten_Project_publish_ProjectPublish_Plugins_AdvancedSteamSessions_Source_AdvancedSteamSessions_Classes_SteamNotificationsSubsystem_h__Script_AdvancedSteamSessions_2258596629{
	TEXT("/Script/AdvancedSteamSessions"),
	Z_CompiledInDeferFile_FID_home_daantje_Documents_SchoolProjecten_Project_publish_ProjectPublish_Plugins_AdvancedSteamSessions_Source_AdvancedSteamSessions_Classes_SteamNotificationsSubsystem_h__Script_AdvancedSteamSessions_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_home_daantje_Documents_SchoolProjecten_Project_publish_ProjectPublish_Plugins_AdvancedSteamSessions_Source_AdvancedSteamSessions_Classes_SteamNotificationsSubsystem_h__Script_AdvancedSteamSessions_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0,
};
// ********** End Registration *********************************************************************
