...
void IAdvancedFriendsInterface::Execute_OnPlayerLoginChanged(UObject* O, int32 PlayerNum)
{
	...
	if (Func)
	{
		Parms.PlayerNum=std::move(PlayerNum);
...
// ********** Begin Function OnPlayerLoginChanged constinit property declarations ******************
	static const UECodeGen_Private::FIntPropertyParams NewProp_PlayerNum;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End Function OnPlayerLoginChanged constinit property declarations ********************
	static const UECodeGen_Private::FFunctionParams FuncParams;
};

// ********** Begin Function OnPlayerLoginChanged Property Definitions *****************************
...
// ********** End Function OnPlayerLoginChanged Property Definitions *******************************
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UAdvancedFriendsInterface_OnPlayerLoginChanged_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UAdvancedFriendsInterface, nullptr, "OnPlayerLoginChanged", 	Z_Construct_UFunction_UAdvancedFriendsInterface_OnPlayerLoginChanged_Statics::PropPointers, 
	UE_ARRAY_COUNT(Z_Construct_UFunction_UAdvancedFriendsInterface_OnPlayerLoginChanged_Statics::PropPointers), 
sizeof(AdvancedFriendsInterface_eventOnPlayerLoginChanged_Parms),
...
void IAdvancedFriendsInterface::Execute_OnPlayerLoginStatusChanged(UObject* O, EBPLoginStatus PreviousStatus, EBPLoginStatus NewStatus, FBPUniqueNetId PlayerUniqueNetID)
{
	...
	if (Func)
	{
		Parms.PreviousStatus=std::move(PreviousStatus);
...
// ********** Begin Function OnPlayerLoginStatusChanged constinit property declarations ************
	...
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End Function OnPlayerLoginStatusChanged constinit property declarations **************
	static const UECodeGen_Private::FFunctionParams FuncParams;
};

// ********** Begin Function OnPlayerLoginStatusChanged Property Definitions ***********************
...
// ********** End Function OnPlayerLoginStatusChanged Property Definitions *************************
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UAdvancedFriendsInterface_OnPlayerLoginStatusChanged_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UAdvancedFriendsInterface, nullptr, "OnPlayerLoginStatusChanged", 	Z_Construct_UFunction_UAdvancedFriendsInterface_OnPlayerLoginStatusChanged_Statics::PropPointers, 
	UE_ARRAY_COUNT(Z_Construct_UFunction_UAdvancedFriendsInterface_OnPlayerLoginStatusChanged_Statics::PropPointers), 
sizeof(AdvancedFriendsInterface_eventOnPlayerLoginStatusChanged_Parms),
...
void IAdvancedFriendsInterface::Execute_OnPlayerVoiceStateChanged(UObject* O, FBPUniqueNetId PlayerId, bool bIsTalking)
{
	...
	if (Func)
	{
		...
		Parms.bIsTalking=std::move(bIsTalking);
		O->ProcessEvent(Func, &Parms);
	}
}
...
// ********** Begin Function OnPlayerVoiceStateChanged constinit property declarations *************
	...
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End Function OnPlayerVoiceStateChanged constinit property declarations ***************
	static const UECodeGen_Private::FFunctionParams FuncParams;
};

// ********** Begin Function OnPlayerVoiceStateChanged Property Definitions ************************
const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UAdvancedFriendsInterface_OnPlayerVoiceStateChanged_Statics::NewProp_PlayerId = { "PlayerId", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AdvancedFriendsInterface_eventOnPlayerVoiceStateChanged_Parms, PlayerId), Z_Construct_UScriptStruct_FBPUniqueNetId, METADATA_PARAMS(0, nullptr) }; // 3384203214
...
// ********** End Function OnPlayerVoiceStateChanged Property Definitions **************************
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UAdvancedFriendsInterface_OnPlayerVoiceStateChanged_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UAdvancedFriendsInterface, nullptr, "OnPlayerVoiceStateChanged", 	Z_Construct_UFunction_UAdvancedFriendsInterface_OnPlayerVoiceStateChanged_Statics::PropPointers, 
	UE_ARRAY_COUNT(Z_Construct_UFunction_UAdvancedFriendsInterface_OnPlayerVoiceStateChanged_Statics::PropPointers), 
sizeof(AdvancedFriendsInterface_eventOnPlayerVoiceStateChanged_Parms),
...
// ********** Begin Function OnSessionInviteAccepted constinit property declarations ***************
	...
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End Function OnSessionInviteAccepted constinit property declarations *****************
	static const UECodeGen_Private::FFunctionParams FuncParams;
};

// ********** Begin Function OnSessionInviteAccepted Property Definitions **************************
...
// ********** End Function OnSessionInviteAccepted Property Definitions ****************************
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UAdvancedFriendsInterface_OnSessionInviteAccepted_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UAdvancedFriendsInterface, nullptr, "OnSessionInviteAccepted", 	Z_Construct_UFunction_UAdvancedFriendsInterface_OnSessionInviteAccepted_Statics::PropPointers, 
	UE_ARRAY_COUNT(Z_Construct_UFunction_UAdvancedFriendsInterface_OnSessionInviteAccepted_Statics::PropPointers), 
sizeof(AdvancedFriendsInterface_eventOnSessionInviteAccepted_Parms),
...
// ********** Begin Function OnSessionInviteReceived constinit property declarations ***************
	static const UECodeGen_Private::FStructPropertyParams NewProp_PersonInviting;
	static const UECodeGen_Private::FStructPropertyParams NewProp_SearchResult;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End Function OnSessionInviteReceived constinit property declarations *****************
	static const UECodeGen_Private::FFunctionParams FuncParams;
};

// ********** Begin Function OnSessionInviteReceived Property Definitions **************************
...
// ********** End Function OnSessionInviteReceived Property Definitions ****************************
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UAdvancedFriendsInterface_OnSessionInviteReceived_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UAdvancedFriendsInterface, nullptr, "OnSessionInviteReceived", 	Z_Construct_UFunction_UAdvancedFriendsInterface_OnSessionInviteReceived_Statics::PropPointers, 
	UE_ARRAY_COUNT(Z_Construct_UFunction_UAdvancedFriendsInterface_OnSessionInviteReceived_Statics::PropPointers), 
sizeof(AdvancedFriendsInterface_eventOnSessionInviteReceived_Parms),
...
// ********** Begin Interface UAdvancedFriendsInterface constinit property declarations ************
// ********** End Interface UAdvancedFriendsInterface constinit property declarations **************
	static UObject* (*const DependentSingletons[])();
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UAdvancedFriendsInterface_OnPlayerLoginChanged, "OnPlayerLoginChanged" }, // 2572090503
		{ &Z_Construct_UFunction_UAdvancedFriendsInterface_OnPlayerLoginStatusChanged, "OnPlayerLoginStatusChanged" }, // 2289256205
		{ &Z_Construct_UFunction_UAdvancedFriendsInterface_OnPlayerVoiceStateChanged, "OnPlayerVoiceStateChanged" }, // 2403165564
		{ &Z_Construct_UFunction_UAdvancedFriendsInterface_OnSessionInviteAccepted, "OnSessionInviteAccepted" }, // 2689671701
		{ &Z_Construct_UFunction_UAdvancedFriendsInterface_OnSessionInviteReceived, "OnSessionInviteReceived" }, // 1490404160
	};
...
DEFINE_VTABLE_PTR_HELPER_CTOR_NS(, UAdvancedFriendsInterface);
// ********** End Interface UAdvancedFriendsInterface **********************************************

// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_home_daantje_Documents_SchoolProjecten_Project_publish_ProjectPublish_Plugins_AdvancedSessions_Source_AdvancedSessions_Classes_AdvancedFriendsInterface_h__Script_AdvancedSessions_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UAdvancedFriendsInterface, UAdvancedFriendsInterface::StaticClass, TEXT("UAdvancedFriendsInterface"), &Z_Registration_Info_UClass_UAdvancedFriendsInterface, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAdvancedFriendsInterface), 1192643285U) },
	};
}; // Z_CompiledInDeferFile_FID_home_daantje_Documents_SchoolProjecten_Project_publish_ProjectPublish_Plugins_AdvancedSessions_Source_AdvancedSessions_Classes_AdvancedFriendsInterface_h__Script_AdvancedSessions_Statics 
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_home_daantje_Documents_SchoolProjecten_Project_publish_ProjectPublish_Plugins_AdvancedSessions_Source_AdvancedSessions_Classes_AdvancedFriendsInterface_h__Script_AdvancedSessions_1917847298{
	TEXT("/Script/AdvancedSessions"),
	Z_CompiledInDeferFile_FID_home_daantje_Documents_SchoolProjecten_Project_publish_ProjectPublish_Plugins_AdvancedSessions_Source_AdvancedSessions_Classes_AdvancedFriendsInterface_h__Script_AdvancedSessions_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_home_daantje_Documents_SchoolProjecten_Project_publish_ProjectPublish_Plugins_AdvancedSessions_Source_AdvancedSessions_Classes_AdvancedFriendsInterface_h__Script_AdvancedSessions_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0,
};
// ********** End Registration *********************************************************************
